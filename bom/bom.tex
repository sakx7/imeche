...
\end{tblr}
\vspace{1.2em}
\captionof{table}{Bill of Material for the Mechanical Components}
...
%\begin{tblrtikzbelow}
%	\draw[line width=0.2em]
%	(h21-|v7) rectangle ($(h21-|v8)!-1!(h20-|v8)$)
%	node[midway] {$\Sigma=\pounds14.40$};
%\end{tblrtikzbelow}
\begin{tblr}{
        colspec = {clllcccl},
		row{1} = {font=\bfseries,c,m},
		column{4} = {c,m},
		hline{1-Y}={-}{solid},
		vline{1-Z} = {1-Y}{solid,0.2em},
        hline{1,2,6,9,11,13,15,18,19,Y} = {0.2em},
		hline{Z}={7}{solid,.2em},
		vline{7-8}={Z}{solid,.2em},
		row{Z}={fg=blue}
	}
    ...
    & & & & & & $\Sigma=\pounds14.40$ & &    \\
\end{tblr}
\captionof{table}{Bill of Materials for the  Electronical Components}
\end{adjustbox}\hspace*{2em}%
