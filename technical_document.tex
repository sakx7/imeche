...
\begin{tikzpicture}[
	...
	\draw (vdd1) -- (vdd2) coordinate[midway] (mid1)
	(mid1) -- ++(0,0.5)
	node[above] {\large Vcc};
	...
	\node[below=0.7] at (gnd) {\large GND};
...
%	}
	...
	\node[label={[font=\large]120:\textbf{PWR}}, draw, circle, fill=white, draw=black, scale=0.5,thick] at (pwr) {};

	\node[label={[font=\large]120:\textbf{DIR}}, draw, circle, fill=white, draw=black, scale=0.5,thick] at (dir) {};
